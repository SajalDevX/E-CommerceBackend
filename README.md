...
[![MongoDB Version](https://img.shields.io/badge/MongoDB-4.4.6-47A248?logo=mongodb)](https://www.mongodb.com/)
...
- [MongoDB](https://www.mongodb.com/) - MongoDB is a powerful, open-source document-oriented database system that provides high performance, high availability, and easy scalability for modern application development.
...
### Curl
    ...
    curl -X 'GET' \ 'http://localhost:8080/login?email=Sajal599%40gmail.com&password=p1234&userType=user' \ 
    -H 'accept: application/json'

### Request URL

    http://localhost:8080/login?email=Sajal599%40gmail.com&password=p1234&userType=user
...
```
 curl -X 'GET' \
  'http://localhost:8080/forget-password?email=Sajal599%40gmail.com' \
  -H 'accept: application/json'
``` 
...
```
{
  ...
  "data": "verification code sent to Sajal599@gmail.com"
}
...
```
curl -X 'GET' \
  'http://localhost:8080/verify-change-password?email=Sajal599%40gmail.com&verificationCode=9889&password=p1234' \
  -H 'accept: application/json'
``` 
...
```
http://localhost:8080/verify-change-password?email=Sajal599%40gmail.com&verificationCode=9189&newPassword=p1234
``` 
...
curl -X 'POST' \
  ...
  -F 'file=@Sajal.jpeg;type=image/jpeg'
``` 
...
<a href="https://twitter.com/Sajalcse" target="_blank">
  <img src="https://avatars.githubusercontent.com/SajalDevX" width="80" align="left">
</a>

** Sajal Kumar Jana**

[![Web](https://img.shields.io/badge/-web-grey?logo=appveyor)](https://github.com/SajalDevX)
[![Linkedin](https://img.shields.io/badge/-linkedin-grey?logo=linkedin)](https://www.linkedin.com/in/sajal-kumar-jana-803917289?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app)

# License
```
Copyright 2023 SajalDevX ( Sajal Kumar Jana)
